...
Many models in this army list have the Daemons of Khorne, Daemons of Nurgle, Daemons of Slaanesh or Daemons of Tzeentch special rule listed among their special rules. These special rules represent the Daemonic Alignment of that model, indicating to which of the Ruinous Powers the Daemon is bound:
...
Note that if this unit takes Plague Proboscises, the Initiative modifier applies only to the Rot Flies, not to their riders.
...
Enemy units cannot claim any bonus combat result points for being engaged within this unit's flank or rear arc.
...
| --- | --- | --- | --- |
| 12" | 5 | -1 | Column of Fire, Cumbersome |
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S | -2 | Armour Bane (1), Strike Last |
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S+2 | -2 | Armour Bane (1), Multiple Wounds (D3) |
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| 36" | 8 | -2 | Armour Bane (2), Cannon Fire, Cumbersome, Multiple Wounds (D3) |
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| 12" | S+1 | -1 | Move & Shoot, Multiple Wounds (D3) |
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| 18" | 3 | - | Flaming Attacks, Multiple Shots (2), Quick Shot |

### Great Axe

| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S+2 | -3 | Armour Bane (2), Monster Slayer, Requires Two Hands, Strike Last |

### Harvester Cannon

| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| 12" | 4 | -1 | Cumbersome, Needs More Nails |

Notes: This weapon shoots like a cannon firing grapeshot, using the Needs More Nails special rule. If a 'Misfire' is rolled on the Artillery dice, this model loses a single Wound (instead of rolling on a Misfire table).
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S | -1 | Cleaving Blow |

### Impaling Claws

| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S | -2 | Killing Blow, Strike First |

### Iron Claw

| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S | -3 | Killing Blow |
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S | -2 | Armour Bane (1), Strike First |
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S | -1 | Armour Bane (2), Extra Attacks (+1), Requires Two Hands |

### Plagueflail

| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| Combat | S+2 | -3 | Multiple Wounds (D3) |
...
| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| 18" | 4 | -1 | Flaming Attacks, Multiple Shots (D3+1), Quick Shot |
...
Notes: In combat, a Rot Fly makes one of its attacks each turn with this weapon.

### Warp Gaze

| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| 48" | 6 | -3 | Cumbersome, Multiple Wounds (2), Through & Through |

### Warpflame

| Range | Strength | Armour Piercing | Special Rules |
| --- | --- | --- | --- |
| 18" | 4 | -1 | Flaming Attacks, Move & Shoot, Multiple Shots (D3), Quick Shot |
...
"This section details the Grand Army composition list for the Daemons of Chaos. This is the default army composition list for this faction. Using this army composition list to write your muster list will give you the widest variety of units to choose from and create a broad and balanced force.
...
#### Plague Wind (Signature Spell)

"A debilitating cloud of noxious air forms, swirling around the battlefield and infecting all it touches."

| Type | Casting Value | Range |
| --- | --- | --- |
| Magical Vortex | 7+ | 12" |

Daemons of Nurgle only. Remains in Play. Place a small (3") blast template so that its central hole is within 12" of the caster. Whilst in play, the template is treated as dangerous terrain. The template moves D6" in a random direction during every Start of Turn sub-phase. Any unit (friend or foe, but not including Daemons of Nurgle) the moving template touches or moves over suffers a -1 modifier to its Toughness characteristic for the remainder of the turn.

#### Cacophonic Hymn (Signature Spell)

"The Daemon's unnatural song peels away the enchantments that protect its enemies and its perverse melody boggles their wits."

| Type | Casting Value | Range |
| --- | --- | --- |
| Hex | 10+ | 12" |

Daemons of Slaanesh only. Remains in Play. If this spell is cast, the effects of any enchantment spell previously cast on the target unit immediately expire. In addition, whilst this spell is in play, the target unit becomes subject to the Stupidity special rule.

#### Pink Fire (Signature Spell)

"As the cackling Daemon prances and gestures, pink flames rise from the earth to envelope its enemies."

| Type | Casting Value | Range |
| --- | --- | --- |
| Magic Missile | 8+ | 18" |

Daemons of Tzeentch only. The target enemy unit suffers D3+3 Strength 3 hits, each with an AP of - and with the Flaming Attacks special rule.

#### Gift of Mutation (Signature Spell)

"The Daemon cackles maniacally as the warping magic of Tzeentch flows through its enemies, sending waves of mutation through their minds and bodies."

| Type | Casting Value | Range |
| --- | --- | --- |
| Hex | 8+/12+ | 12" |

Daemons of Tzeentch only. If this spell is cast with a casting result of 8 or more, the target enemy unit suffers a -D3 modifier to one of the following characteristics (to a minimum of 1, chosen by the casting player). If this spell is cast with a casting result of 12 or more, the target enemy unit suffers a -D3 modifier to two of the following characteristics (to a minimum of 1, chosen by the casting player). This spell lasts until your next Start of Turn sub-phase:
...
"These sections detail Daemonic Gifts and Icons – unique magic items which can be purchased only by models within a Daemons of Chaos army. These work like Common magic items, as described in the Warhammer: the Old World rulebook, however, models within a Daemons of Chaos army cannot purchase Common magic items. Daemonic Gifts do not affect a model's mount (should it have one).
...
"The following Daemonic Gifts can be purchased by any Daemon, regardless of their Daemonic Alignment:"
...
"The following Daemonic Icons can be purchased by any Daemon, regardless of their Daemonic Alignment:"

#### Banner of Unholy Victory (Magic Standard)
...
#### Totem of Eternal War (Magic Standard)
...
#### Standard of Chaotic Glory (Magic Standard)
...
"The following Daemonic Gifts can only be purchased by Daemons of Khorne:"
...
"The following Daemonic Icons can only be purchased by Daemons of Khorne:"

#### Skull Totem (Magic Standard)
...
#### Great Standard of Sundering (Magic Standard)
...
#### Icon of Endless War (Magic Standard)
...
"The following Daemonic Gifts can only be purchased by Daemons of Nurgle:"

#### Nurgling Infestation (Ability)
...
#### Sloppity Bilepiper (Ability)

35 points

The infectious tunes of a Bilepiper fill their companions with joyous murrain.

Daemonic Heralds whose troop type is infantry only. Friendly units with the Daemons of Nurgle special rule that begin their movement within this model's Command range have a +1 modifier to their Movement characteristic.

#### Spoilpox Scrivener (Ability)
...
"The following Daemonic Icons can only be purchased by Daemons of Nurgle:"

#### Icon of Eternal Virulence (Magic Standard)
...
#### Standard of Seeping Decay (Magic Standard)
...
"The following Daemonic Gifts can only be purchased by Daemons of Slaanesh:"

#### Infernal Enrapturess (Ability)
...
"The following Daemonic Icons can only be purchased by Daemons of Slaanesh:"

#### Banner of Acquiescence (Magic Standard)
...
#### Rapturous Standard (Magic Standard)
...
"The following Daemonic Gifts can only be purchased by Daemons of Tzeentch:"

#### Staff of Change (Ability)
...
"The following Daemonic Icons can only be purchased by Daemons of Tzeentch:"

#### Banner of Discord (Magic Standard)
...
#### Banner of Change (Magic Standard)
...
#### Icon of Sorcery* (Magic Standard)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Bloodthirster | 8 | 10 | 5 | 6 | 6 | 6 | 7 | 6 | 9 |

Unit Category: Character  
Troop Type: Behemoth Character  
Base Size: 50 x 50 mm (min), 100 x 150 mm (max)  
Unit Size: 1  
Equipment: Hand weapon and heavy armour

Special Rules: Daemonic, Daemonic Charge, Daemons of Khorne, Fly (10), Furious Charge, Impact Hits (D3), Impetuous, Infernal Favour (2), Large Target, Magic Resistance (-2), Terror

Optional Rules: Bloodflail, Great Axe, Lash of Khorne
...
Unit Size: 1  
Equipment: Hand weapon, ensorcelled weapon and light armour
...
Optional Rules: Daemon of Khorne, Daemon of Nurgle, Daemon of Slaanesh, Daemon of Tzeentch

### Daemonic Herald of Khorne

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Herald of Khorne | 5 | 7 | 4 | 5 | 4 | 2 | 6 | 3 | 8 |

Unit Category: Character  
Troop Type: Heavy Infantry Character  
Base Size: 30 x 30 mm  
Unit Size: 1  
Equipment: Hellblade and calloused hide (counts as light armour)

Special Rules: Daemonic, Daemons of Khorne, Furious Charge, Impetuous, Infernal Favour (1), Magic Resistance (-1)
...
| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Herald of Nurgle | 4 | 5 | 5 | 5 | 5 | 2 | 4 | 3 | 8 |
...
Magic: Herald of Nurgle that is a Wizard uses spells from Battle Magic, Daemonology, or Dark Magic.

Special Rules: Daemonic, Daemon of Nurgle, Infernal Favour (1), Lore of Daemons, Poisoned Attacks, Regeneration (6+)

Optional Rules: Death's Heads

### Daemonic Herald of Slaanesh

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Herald of Slaanesh | 6 | 6 | 4 | 4 | 3 | 2 | 6 | 3 | 8 |
...
Magic: Herald of Slaanesh that is a Wizard uses spells from Daemonology, Dark Magic, or Illusion.

Special Rules: Daemonic, Daemon of Slaanesh, Infernal Favour (1), Lore of Daemons

### Daemonic Herald of Tzeentch

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Herald of Tzeentch | 4 | 3 | 4 | 3 | 3 | 2 | 3 | 2 | 8 |

Unit Category: Character  
Troop Type: Regular Infantry Character  
Base Size: 30 x 30 mm  
Unit Size: 1  
Equipment: Hand weapon and flames of Tzeentch

Magic: Herald of Tzeentch is a Level 1 Wizard who uses spells from Battle Magic, Daemonology, Dark Magic, Elementalism, or Illusion.

Special Rules: Daemonic, Daemon of Tzeentch, Infernal Favour (1), Lore of Daemons

### Great Unclean One

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Great Unclean One | 5 | 6 | 3 | 6 | 7 | 7 | 4 | 5 | 9 |
...
Magic: Great Unclean One is a Level 1 Wizard who uses spells from Battle Magic, Daemonology, or Dark Magic.

Special Rules: Daemonic, Daemon of Nurgle, Infernal Favour (2), Large Target, Lore of Daemons, Poisoned Attacks, Regeneration (5+), Stomp Attacks (D3+1), Terror

Optional Rules: Bilesword, Plagueflail

### Keeper of Secrets

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Keeper of Secrets | 8 | 7 | 6 | 6 | 6 | 6 | 7 | 6 | 9 |
...
Magic: Keeper of Secrets is a Level 1 Wizard who uses spells from Daemonology, Dark Magic, or Illusion.

Special Rules: Daemonic, Daemon of Slaanesh, Infernal Favour (2), Large Target, Lore of Daemons, Stomp Attacks (D3), Swiftstride, Terror
...
Base Size: 50 x 50 mm (min), 100 x 150 mm (max)  
Unit Size: 1  
Equipment: Hand weapon and staff of Tzeentch (counts as great weapon)

Magic: Lord of Change is a Level 2 Wizard who uses spells from Battle Magic, Daemonology, Dark Magic, Elementalism, or Illusion.

Special Rules: Daemonic, Daemon of Tzeentch, Flaming Attacks, Fly (9), Infernal Favour (2), Large Target, Lore of Daemons, Stomp Attacks (D3), Swiftstride, Terror

Optional Rules: Tzeentchian Wand
...
| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Juggernaut of Khorne | 7 | 4 | - | 5 (+1) | (+1) | 2 | 2 | - |
...
Special Rules: Armoured Hide (1), Daemonic, Daemon of Khorne, First Charge, Impact Hits (2), Swiftstride

### Palanquin of Nurgle

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Palanquin of Nurgle | 4 | 3 | - | 3 | - | (+4) | 3 | D6+1 | - |
...
Special Rules: Armour Bane (1, Steed of Slaanesh only), Counter Charge, Daemonic, Daemon of Slaanesh, Fast Cavalry, Poisoned Attacks (Steed of Slaanesh only), Swiftstride
...
| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Beast of Nurgle | 5 | 3 | 0 | 4 | 5 | 4 | 2 | D6+1 | 7 |

Unit Category: Infantry  
Troop Type: Monstrous Infantry  
Base Size: 50 x 75 mm  
Unit Size: 2+  
Equipment: Hand weapons and writhing tentacles

Special Rules: Attention Seeker, Close Order, Daemonic, Daemons of Nurgle, Impetuous, Infernal Favour (1), Loner, Poisoned Attacks, Random Attacks, Regeneration (5+), Slime Trail

### Bloodletters of Khorne

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Bloodletter | 5 | 5 | 3 | 4 | 3 | 1 | 4 | 1 | 7 |
| Bloodreaper | 5 | 5 | 3 | 4 | 3 | 1 | 4 | 2 | 7 |

Unit Category: Infantry  
Troop Type: Heavy Infantry  
Base Size: 30 x 30 mm  
Unit Size: 8+  
Equipment: Hellblades and calloused hides (counts as light armour)

Special Rules: Close Order, Daemonic, Daemons of Khorne, Impetuous, Magic Resistance (-1)

### Blue Horrors of Tzeentch

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Blue Horror | 4 | 2 | 3 | 3 | 3 | 1 | 3 | 1 | 7 |
| Ectoplasmic Horror | 4 | 2 | 3 | 3 | 3 | 1 | 3 | 2 | 7 |

Unit Category: Infantry  
Troop Type: Regular Infantry  
Base Size: 25 x 25 mm  
Unit Size: 9+  
Equipment: Hand weapons and flames of Tzeentch
...
| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Brimstone Horrors | 5 | 2 | 2 | 2 | 3 | 6 | 2 | 4 | 5 |
...
Special Rules: Daemonic, Fly (8), Furious Charge, Skirmishers, Swiftstride, Vanguard

Optional Rules: Daemons of Khorne, Daemons of Nurgle, Daemons of Slaanesh, Daemons of Tzeentch

### Daemonettes of Slaanesh

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Daemonette | 5 | 4 | 3 | 3 | 3 | 1 | 5 | 1 | 7 |
| Alluress | 5 | 4 | 3 | 3 | 3 | 1 | 5 | 2 | 7 |
...
Special Rules: Close Order, Daemonic, Daemons of Slaanesh
...
| Pyroclaster | 6 | 2 | 5 | 4 | 4 | 2 | 4 | 2 | 7 |
| Exalted Flamer | 6 | 2 | 5 | 4 | 4 | 3 | 4 | 2 | 7 |

Unit Category: Infantry  
Troop Type: Regular Infantry  
Base Size: 30 x 30 mm  
Unit Size: 3-6  
Equipment: Hand weapons and warpflame

Magic: An Exalted Flamer is a Level 1 Wizard who uses spells from Daemonology, Dark Magic, Elementalism, or Illusion.

Special Rules: Daemonic, Daemons of Tzeentch, Flaming Attacks, Infernal Favour (1, Exalted Flamer only), Lore of Daemons (Exalted Flamer only), Move Through Cover, Skirmishers

### Nurglings

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nurglings | 4 | 2 | 0 | 2 | 3 | 7 | 2 | D3+1 | 5 |
...
Special Rules: Daemonic, Daemons of Nurgle, Loner, Poisoned Attacks, Random Attacks, Regeneration (6+), Skirmishers
...
Special Rules: Close Order, Daemonic, Daemons of Tzeentch, Scintillating Sorcery
...
Special Rules: Close Order, Daemonic, Daemons of Nurgle, Poisoned Attacks, Regeneration (6+)
...
| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Bloodletter | - | 5 | 3 | 4 | 4 | 3 | 4 | 1 | 7 |
| Bloodreaper | - | 5 | 3 | 4 | 4 | 3 | 4 | 2 | 7 |
| Juggernaut of Khorne | 7 | 4 | - | 5 | - | - | 2 | 2 | - |
...
- Bloodletters: Hellblades and calloused hides (counts as light armour)
- Juggernauts of Khorne: Brass bound hooves and brazen hide (counts as barding)

Special Rules: Armoured Hide (1), Close Order, Daemonic, Daemons of Khorne, Impact Hits (2), Impetuous, Magic Resistance (-1), Swiftstride

### Fiends of Slaanesh

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Fiend of Slaanesh | 8 | 4 | 0 | 4 | 4 | 3 | 6 | 3 | 7 |

Unit Category: Cavalry  
Troop Type: Monstrous Cavalry  
Base Size: 50 x 75 mm  
Unit Size: 3+  
Equipment: Piercing claws and venomous tail

Special Rules: Close Order, Daemonic, Daemons of Slaanesh, Soporific Musk, Swiftstride

### Flesh Hounds of Khorne

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Flesh Hound | 8 | 5 | 0 | 4 | 4 | 2 | 4 | 2 | 7 |

Unit Category: Cavalry  
Troop Type: Heavy Cavalry  
Base Size: 30 x 60 mm  
Unit Size: 5+  
Equipment: Claws and fangs (counts as hand weapons) and calloused hides (counts as light armour)

Special Rules: Armour Bane (1), Close Order, Counter Charge, Daemonic, Daemons of Khorne, Impetuous, Magic Resistance (-2)

Optional Rules: Ambushers, Vanguard

### Plague Drones of Nurgle

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Plaguebearer | - | 3 | 3 | 4 | 5 | 3 | 2 | 1 | 7 |
| Plagueridden | - | 3 | 3 | 4 | 5 | 3 | 2 | 2 | 7 |
| Rot Fly | 1 | 3 | - | 5 | - | - | 2 | 3 | - |
...
- Plaguebearers: Plagueswords and death's heads
- Rot Flies: Filth-encrusted claws (counts as hand weapons)

Special Rules: Armour Bane (2, Rot Fly only), Daemonic, Daemons of Nurgle, Fly (9), Poisoned Attacks, Regeneration (6+), Skirmishers, Swiftstride

Optional Rules: Plague Proboscis, Venom Sting
...
Special Rules: Daemonic, Daemons of Tzeentch, Fly (9), Loner, Skirmishers, Slashing Attack

### Seekers of Slaanesh

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Seeker | - | 4 | 3 | 3 | 3 | 1 | 5 | 1 | 7 |
| Heartseeker | - | 4 | 3 | 3 | 3 | 1 | 5 | 2 | 7 |
| Steed of Slaanesh | 9 | 3 | - | 3 | - | - | 5 | 1 | - |
...
- Seekers: Piercing claws
- Steeds of Slaanesh: Claws and fangs (counts as a hand weapon)

Special Rules: Armour Bane (1, Steed of Slaanesh only), Counter Charge, Daemonic, Daemons of Slaanesh, Fast Cavalry, Open Order, Poisoned Attacks (Steed of Slaanesh only), Skirmishers, Swiftstride
...
| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Blood Throne | 7 | 5 | - | 5 | 5 | 4 | 2 | 3 | - |
| Bloodletter Crew (x2) | - | 5 | 3 | 4 | - | - | 4 | 1 | 7 |

A Blood Throne of Khorne may only be included in your army as a character's mount. Its points are added to that of its rider.
...
Special Rules: Close Order, Daemonic, Daemons of Khorne, First Charge, Gorefeast, Impact Hits (D6+1), Impetuous, Totem of Endless Bloodletting

### Burning Chariot of Tzeentch

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Burning Chariot of Tzeentch | - | - | - | 4 | 4 | 4 | - | - | - |
| Exalted Flamer | - | 2 | 5 | 4 | - | - | 4 | 2 | 7 |
| Blue Horror Crew (x3) | - | 2 | 3 | 3 | - | - | 3 | 1 | 7 |
| Screamer (x2) | 1 | 3 | - | 4 | - | - | 4 | 2 | - |

A Chariot of Tzeentch may only be included in your army as a character's mount. Its points are added to that of its rider.
...
Special Rules: Close Order, Daemonic, Daemons of Tzeentch, Fly (9), Impact Hits (D6+1), Lore of Daemons, Slashing Attack (Screamers only)

### Chariot of Tzeentch

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Chariot of Tzeentch | - | - | - | 4 | 4 | 4 | - | - | - |
| Screamer (x2) | 1 | 3 | - | 4 | - | - | 4 | 2 | - |
...
| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Exalted Seeker Chariot | - | - | - | 4 | 4 | 6 | - | - | - |
| Daemonette Crew (x3) | - | 4 | 3 | 3 | - | - | 5 | 1 | 7 |
| Steed of Slaanesh (x4) | 9 | 3 | - | 3 | - | - | 5 | 1 | - |

An Exalted Seeker Chariot of Slaanesh may only be included in your army as a character's mount. Its points are added to that of its rider.
...
Special Rules: Armour Bane (1, Steed of Slaanesh only), Close Order, Daemonic, Daemons of Slaanesh, First Charge, Impact Hits (D6+1), Poisoned Attacks (Steed of Slaanesh only)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Hellflayer | - | - | - | 4 | 4 | 4 | - | - | - |
| Exalted Alluress | - | 5 | 3 | 3 | - | - | 5 | 2 | 7 |
| Daemonette Crew (x2) | - | 4 | 3 | 3 | - | - | 5 | 1 | 7 |
| Steed of Slaanesh (x2) | 9 | 3 | - | 3 | - | - | 5 | 1 | - |

Unit Category: Chariot  
Troop Type: Light Chariot  
Base Size: 100 x 60 mm  
Unit Size: 1  
Armour Value: 5+
...
Special Rules: Armour Bane (1, Steed of Slaanesh only), Close Order, Counter Charge, Daemonic, Daemons of Slaanesh, First Charge, Impact Hits (2D6+1), Poisoned Attacks (Steed of Slaanesh only), Swiftstride

### Seeker Chariot of Slaanesh

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Seeker Chariot | - | - | - | 4 | 4 | 4 | - | - | - |
| Daemonette Crew (x2) | - | 4 | 3 | 3 | - | - | 5 | 1 | 7 |
| Steed of Slaanesh (x2) | 9 | 3 | - | 3 | - | - | 5 | 1 | - |

A Seeker Chariot of Slaanesh may be included in your army as a character's mount. If so, its points are added to that of its rider.
...
Special Rules: Armour Bane (1, Steed of Slaanesh only), Counter Charge, Daemonic, Daemons of Slaanesh, First Charge, Impact Hits (D3+1), Open Order, Poisoned Attacks (Steed of Slaanesh only), Swiftstride

### Skull Cannon of Khorne

| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Skull Cannon | 7 | 5 | - | 5 | 5 | 4 | 2 | 3 | - |
| Bloodletter Crew (2x) | - | 5 | 3 | 4 | - | - | 4 | 1 | 7 |
...
Special Rules: Brazen Wheels, Close Order, Daemonic, Daemons of Khorne, First Charge, Impact Hits (D3+1), Impetuous, Stomp Attacks (D3)
...
| Unit | M | WS | BS | S | T | W | I | A | Ld |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Soul Grinder | 8 | 3 | 3 | 6 | 6 | 6 | 3 | 4 | 7 |

Unit Category: Monster  
Troop Type: Behemoth  
Base Size: 150 x 100 mm  
Unit Size: 1  
Equipment: Hand weapon, iron claw, harvester cannon and daemonic flesh (counts as heavy armour)

Special Rules: Close Order, Daemonic, Furious Charge, Large Target, Reserve Move, Stomp Attacks (D6+1), Terror

Optional Rules: Daemon of Khorne, Daemon of Nurgle, Daemon of Slaanesh, Daemon of Tzeentch, Baleful Torrent, Warp Gaze
